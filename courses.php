...
<?php
   ...
   if (isset($_GET['submit_course'])) {  
      $sql = "INSERT INTO students.courses (course_name) VALUES ('" . $_GET['course_name'] . "')";
      if ($db->query($sql) === TRUE) {
        echo "<span style='color:green;'>Course has been added</span>";
      } 
  ...
  if (isset($_GET['delete'])) {
    ...
    $delete_query = "DELETE FROM `students`.`courses` WHERE `course_id`= $delete_id;";
