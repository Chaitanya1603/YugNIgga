...
<?php
  if (isset($_GET['submit_module'])) {
      $sql = "INSERT INTO students.modules (module_name, id_user, course_id) VALUES ('" . $_GET['module_name'] . "', 1,'" . $_GET['course_name'] . "')";
  ...
  if (isset($_GET['delete'])) {
    ...
    $delete_query = "DELETE FROM `students`.`modules` WHERE `id`= $delete_id;";
