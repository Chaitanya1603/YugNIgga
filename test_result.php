...
foreach ($_GET as $name => $value) {
    ...
    if ($question_id[0] == '' && $question_id[1] > 0) {
        $sql = "INSERT INTO students.test_results (assessment_id, user_id, question_id, answer,submission)
    ...
    <div class="row">
        ...
        <div class="col-md-9">
           ...
           if (isset($_GET['module'])) {
            ...
            $query = "SELECT module_name FROM students.modules WHERE id = $module_id";
            ...
            <?php 
            $b = isset($_GET['module']) ? $_GET['module'] : '';
            echo $_GET['assessment_name'] ?> <br><small><?php echo $b ?>
            </small></h1>
            <hr>
        ...
        <div class="col-md-6">
            <?php
            $i=0;
            $query = "select a.name, q.content, q.type, q.assessment_id, q.id, q.points  from students.questions
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    //$answer_query = "select answer, correct from students.answers where question_id=$row[id]";
                            $answer_query ="SELECT 	a.answer, r.answer as test_results, a.correct
                                            FROM students.test_results r
                                            join students.answers a on r.question_id = a.question_id
