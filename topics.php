...
if (isset($_GET['submit_topic'])) {
    $sql = "INSERT INTO students.topics (course_id,module_id,topic_name,topic_description,id_user) VALUES ('1','1','" . $_GET['topic_name'] . "','" . $_GET['topic_description'] . "','1')";
  ...
  if (isset($_GET['delete'])) {
    ...
    $delete_query = "DELETE FROM `students`.`topics` WHERE `id`= $delete_id;";
